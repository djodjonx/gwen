...
1.  **Analysis:** Locate and analyze the original _Implementation Report_ in `/docs/agent/reports/` to understand the initial context and intent.
...
## _Implementation Post-Mortem_ in `/docs/agent/post-mortem/`.
