...
describe('componentsTemplate', () => {
  ...
  it('defines all 7 required components', () => {
    ...
    for (const name of ['Position', 'Velocity', 'Size', 'PlayerTag', 'Shooter', 'AsteroidTag', 'BulletTag', 'Score']) {
...
describe('sceneTemplate', () => {
  ...
  it('includes all 5 systems', () => {
    ...
    for (const name of ['MovementSystem', 'InputSystem', 'CollisionSystem', 'SpawnSystem', 'RenderSystem']) {
