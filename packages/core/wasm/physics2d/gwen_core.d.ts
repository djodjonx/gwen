...
export class Engine {
  ...
  path_find_2d(from_x: number, from_y: number, to_x: number, to_y: number): number;
  ...
  physics_add_rigid_body(
    ...
    vx: number,
    vy: number,
    ccd_enabled?: number | null,
    extra_solver_iters?: number | null,
  ): number;
  physics_consume_event_metrics(): Uint32Array;
  ...
  physics_get_sensor_state(slot: number, collider_id: number): Uint32Array;
  physics_init(grav_x: number, grav_y: number, _max_entities: number): void;
  physics_remove_rigid_body(slot: number): void;
  physics_set_event_coalescing(_enabled: number): void;
  physics_set_global_ccd_enabled(_enabled: number): void;
  physics_set_quality(preset: number): void;
  physics_step(delta: number): void;
  physics_update_sensor_state(_slot: number, _collider_id: number, _active: number): void;
  /**
 ...
 */
export function get_collision_event_count(): number;
 ...
 */
export function get_collision_events_ptr(): number;
 ...
 */
export function get_path_buffer_ptr(): number;
...
export interface InitOutput {
  ...
  readonly engine_physics_init: (a: number, b: number, c: number, d: number) => void;
  readonly engine_physics_step: (a: number, b: number) => void;
  readonly engine_physics_set_quality: (a: number, b: number) => void;
  readonly engine_physics_set_event_coalescing: (a: number, b: number) => void;
  readonly engine_physics_add_rigid_body: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly engine_physics_remove_rigid_body: (a: number, b: number) => void;
  readonly engine_physics_add_box_collider: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly engine_physics_add_ball_collider: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly engine_physics_get_position: (a: number, b: number, c: number) => void;
  readonly engine_physics_get_linear_velocity: (a: number, b: number, c: number) => void;
  readonly engine_physics_get_sensor_state: (a: number, b: number, c: number, d: number) => void;
  readonly engine_physics_update_sensor_state: (a: number, b: number, c: number, d: number) => void;
  readonly engine_physics_consume_event_metrics: (a: number, b: number) => void;
  readonly engine_physics_get_collision_events_ptr: (a: number) => number;
  readonly engine_physics_get_collision_event_count: (a: number) => number;
  readonly engine_path_find_2d: (a: number, b: number, c: number, d: number, e: number) => number;
  readonly engine_path_get_result_ptr: (a: number) => number;
  readonly engine_stats: (a: number, b: number) => void;
  readonly get_collision_events_ptr: () => number;
  readonly get_path_buffer_ptr: () => number;
  readonly find_path_2d: (a: number, b: number, c: number, d: number) => number;
  readonly get_collision_event_count: () => number;
  readonly engine_remove_entity_from_query: (a: number, b: number) => void;
  readonly engine_physics_set_global_ccd_enabled: (a: number, b: number) => void;
