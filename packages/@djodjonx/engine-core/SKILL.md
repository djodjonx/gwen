...
```typescript
import { createEngine, defineConfig } from '@djodjonx/gwen-engine-core';
...
## Available Resources
- `packages/@djodjonx/engine-core/src/core/ecs.ts`: Core ECS implementation.
- `packages/@djodjonx/engine-core/src/engine/engine.ts`: Main Engine orchestration.
- `packages/@djodjonx/engine-core/src/api/api.ts`: `EngineAPI` implementation.
- `packages/@djodjonx/engine-core/src/wasm/shared-memory.ts`: Memory layout constants.
