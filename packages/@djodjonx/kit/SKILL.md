...
## Available Resources
- `packages/@djodjonx/kit/src/define-plugin.ts`: `definePlugin` factory and lifecycle types.
- `packages/@djodjonx/kit/src/config.ts`: `defineConfig` and project configuration types.
