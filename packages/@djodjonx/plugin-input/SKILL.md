...
## Available Resources
- `packages/@djodjonx/plugin-input/src/keyboard.ts`: List of supported `KeyCodes`.
- `packages/@djodjonx/plugin-input/src/gamepad.ts`: Standard mapping constants (Button A=0, B=1, etc.).
