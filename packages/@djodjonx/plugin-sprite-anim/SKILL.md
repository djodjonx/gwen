...
## Available Resources
- `packages/@djodjonx/plugin-sprite-anim/src/types.ts`: `SpriteAnimController` and `SpriteAnimClip` type definitions.
- `packages/@djodjonx/plugin-sprite-anim/src/runtime.ts`: Core animator engine.
