...
## Available Resources
- `packages/@djodjonx/plugin-debug/src/fps-tracker.ts`: Internal logic for rolling averages and jitter.
- `packages/@djodjonx/plugin-debug/src/types.ts`: `DebugMetrics` and `DebugPluginConfig` types.
