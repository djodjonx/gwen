...
```bash
npm install @djodjonx/gwen-adapter-r3f
```
...
import { GwenProvider, GwenLoop } from '@djodjonx/gwen-adapter-r3f';
...
```tsx
import { useQuery, useEvent, usePhysicsBodyState, useComponentValue, useEntityTransform } from '@djodjonx/gwen-adapter-r3f';
