...
```bash
npm install@gwenengine/gwen-renderer-canvas2d
```
...
- Profile with [@gwenengine/gwen-plugin-debug](../plugin-debug/) to identify bottlenecks
...
- [@gwenengine/gwen-plugin-debug](../plugin-debug/) — Performance monitoring
