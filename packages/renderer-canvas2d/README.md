...
```bash
npm install@gwenjs/gwen-renderer-canvas2d
```
...
- Profile with [@gwenjs/gwen-plugin-debug](../plugin-debug/) to identify bottlenecks
...
- [@gwenjs/gwen-plugin-debug](../plugin-debug/) — Performance monitoring
