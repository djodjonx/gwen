/**
 * @gwenengine/gwen-plugin-html-ui — déclarations de types pour imports Vite
 *
 * Injecté automatiquement dans `.gwen/gwen.d.ts` via `/// <reference types="@gwenengine/gwen-plugin-html-ui/vite-env" />`
